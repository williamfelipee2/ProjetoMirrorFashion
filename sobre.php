...
<body>
   <h1>A Mirror Fashion</h1>
    ...
    <a href="https://maps.google.com.br/?q=Jacarezinho" id="maps">Jacarezinho, no Paraná</a>
    ...
    <iframe id="maps" width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
    ...
    <p>A fundação em <?php print date("Y"); - 1935?> ocorreu no momento da descoberta econônica do interior do Paraná. A 
    família <em>Pelho</em>, tradicional da região, investiu todas as suas economias nessa nova iniciativa, 
    revolucionária para a época. O fundador <em>Eduardo Simões Pelho</em>em, dotado de particular visão 
